# Exercise and Checklist Library — Gestalt in Chart Design: Grouping Within the Standard Forms
...
## Exercise 1 — Engineer grouping within standard chart forms — bar spacing ratios and label association
...
## Exercise 2 — Integrated capstone
...
## B1. Engineer grouping within standard checklist
- [ ] Engineer grouping within standard chart forms — bar spacing ratios and label association, line-chart continuation with crossing legibility and spaghetti-limit management, scatter proximity with overplotting remedies (alpha, jitter, binning) and connector-line warnings, matrix seriation and border-density decisions in heatmaps, small-multiple family binding with shared scales and order logic, plus axis-furniture association chains and annotation layering, selecting chart forms by the grouping structure each data relationship requires?
- [ ] Decisions and their justification are documented for review by a colleague

## B2. Delivery quality checklist
